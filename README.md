...
of REST APIs using [**Serenity/JS**](https://serenity-js.org) and [**Cucumber**](https://github.com/cucumber/cucumber-js),
and comes pre-configured with **TypeScript**, linting, reporting, and example test scenarios.

Use this template to accelerate your test automation setup and generate [Serenity/JS HTML reports](https://serenity-js.org/handbook/reporting/html-reporter/) with trend history, flaky test detection, and an interactive dashboard.
...
- [Serenity/JS HTML Report](https://serenity-js.github.io/serenity-js-cucumber-template/)

## Features

- Pre-configured **Serenity/JS** + **Cucumber** + **TypeScript** setup
- Example feature files and step definitions demonstrating BDD API testing with the Screenplay Pattern
...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://github.com/codespaces/new?ref=main&repo=serenity-js/serenity-js-cucumber-template)
...
npx cucumber-js features/math.feature
...
features/
├── support/
│   └── serenity.config.ts             # Serenity/JS reporting configuration
├── step_definitions/
│   └── *.steps.ts                     # Step definitions
└── *.feature                          # Cucumber feature files

src/
├── Actors.ts                          # Actor configuration (API abilities)
...
**Key files:**
- `features/*.feature` - Cucumber feature files written in Gherkin
- `features/step_definitions/*.steps.ts` - Step definitions implementing the Gherkin steps
- `features/support/serenity.config.ts` - Serenity/JS crew configuration
- `src/Actors.ts` - Actor configuration with API abilities
- Test implementation using the [Screenplay Pattern](https://serenity-js.org/handbook/design/screenplay-pattern/)

## Next steps

- Update the base API URL in [`features/support/serenity.config.ts`](features/support/serenity.config.ts) to point to your API
- Add your feature files to `features/` and step definitions to `features/step-definitions/`
- Learn about REST API testing with Serenity/JS in the [First API Scenario tutorial](https://serenity-js.org/handbook/tutorials/your-first-api-scenario/)
- Review the [CI configuration](.github/workflows/build.yml) and adapt it for your CI provider
...
- [REST API Testing](https://serenity-js.org/api/rest/)
