...
of REST/HTTP APIs using [**Serenity/JS**](https://serenity-js.org) and [**Cucumber**](https://github.com/cucumber/cucumber-js),
and comes pre-configured with **TypeScript**, linting, reporting, and example test scenarios.

Use this template to accelerate your API test automation setup and generate [Serenity BDD living documentation](https://serenity-js.org/handbook/reporting/serenity-bdd-reporter/).

View live reports generated by this template:
- [Serenity BDD living documentation](https://serenity-js.github.io/serenity-js-cucumber-template/)

## Features

- Pre-configured **Serenity/JS** + **Cucumber** + **TypeScript** setup
- Example BDD scenarios demonstrating REST API testing
...
npm test -- features/mathjs-api/expressions.feature

# Run specific scenario by line number
npm test -- features/mathjs-api/expressions.feature:12

# Run scenarios matching a name pattern
npm test -- --name="Multiple expressions"

# Run scenarios with specific tags
npm test -- --tags="@smoke-test and @fast"
```
...
features/
├── mathjs-api/
│   └── expressions.feature                # Cucumber feature files
├── step_definitions/
│   └── expressions.steps.ts               # Cucumber step definitions
└── support/
    └── serenity.config.ts                 # Serenity/JS configuration

src/
├── Actors.ts                              # Screenplay actors configuration
└── maths-api/
    ├── RequestEvaluation.ts               # Example API interaction task
    └── get-endpoint/                      # API endpoint-specific logic
...
- `src/` - Tasks, questions, and interactions following the [Screenplay Pattern](https://serenity-js.org/handbook/design/screenplay-pattern/)
...
- [Tutorial: Your First API Scenario](https://serenity-js.org/handbook/tutorials/your-first-api-scenario/)
